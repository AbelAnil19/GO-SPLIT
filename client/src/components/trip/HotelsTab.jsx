    ...
    if (!trip) {
        return (
            <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-lg font-semibold">{t('hotelsTab.noTargetTitle')}</p>
                <p className="text-gray-500 text-sm">{t('hotelsTab.noTargetDesc')}</p>
            </div>
        );
    }
