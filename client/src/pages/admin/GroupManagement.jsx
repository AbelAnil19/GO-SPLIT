...
const GroupManagement = () => {
    ...
    return (
        <AdminLayout>
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-[#0d191b] dark:text-white mb-2">Group Management</h1>
                <p className="text-gray-600 dark:text-gray-400">Oversee all groups on the platform</p>
            </div>

            <div className="bg-white dark:bg-[#1a1c23] border-2 border-gray-200 dark:border-white/10 rounded-2xl p-6 mb-6">
                <div className="text-3xl font-bold text-[#0d191b] dark:text-white mb-1">{groups.length}</div>
