...
const ExpenseManagement = () => {
    ...
    return (
        <AdminLayout>
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-[#0d191b] dark:text-white mb-2">Expense Management</h1>
                <p className="text-gray-600 dark:text-gray-400">Monitor all expenses across the platform</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-white dark:bg-[#1a1c23] border-2 border-gray-200 dark:border-white/10 rounded-2xl p-6">
                    <div className="text-3xl font-bold text-[#0d191b] dark:text-white mb-1">{expenses.length}</div>
